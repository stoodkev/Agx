...
function startAgX(res,date){
  ...
  function PostChart(date,price)
  {
    ...
    var jsonmetadata= {"tags":["AgX","steem","cryptocurrency","news","minnowsupportproject"],"users":["stoodkev","aggroed"],"image":[process.env.URL+'/A'+date+'.jpg',process.env.URL+'/B'+date+'.jpg'],"links":["https://v2.steemconnect.com/sign/account-witness-vote?witness=stoodkev&amp;approve=1","https://v2.steemconnect.com/sign/account-witness-vote?witness=aggroed&amp;approve=1"],"app":"AgX/1","format":"markdown"};
